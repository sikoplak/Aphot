    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <?php echo form_open("web/role/update", ["class"=>"form-horizontal", "enctype"=>"multipart/form-data"]); ?>
                    <?php echo form_hidden("id",$data->groups_id); ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label for="first_name" class="col-sm-2 control-label">Nama Akses Pengguna</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" id="name" value="<?php echo $data->groups_name; ?>" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-sm-2 control-label">Deskripsi</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" id="description" rows="6"><?php echo $data->groups_description; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="clearfix">
                                    <table id="table-create-edit" class="table table-bordered is_edit">
                                        <tr>
