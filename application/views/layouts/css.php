...
<!-- Sweet Alert -->
<link rel="stylesheet" href="<?php echo site_url('assets/plugins/sweetalert/sweetalert.css');?>">
<!-- Toast-->
<link rel="stylesheet" href="<?php echo site_url('assets/plugins/toast/toastr.min.css');?>">
<!-- Select2-->
